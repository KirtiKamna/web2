...
function preload(){
    ...
    DdayImage = loadImage("pics/marroon.jpg");
...
function setup(){
    ...
    Dday = createSprite(windowWidth * 0.50,windowHeight * 0.38,100,100);
    Dday.addImage(DdayImage)
    Dday.scale = 0.6;
    ...
    kiss= createSprite(windowWidth*0.5,windowHeight * 0.75,100,100);
    kiss.addAnimation("chauu",kissAnimation)
    kiss.scale= 0.5

    frame = createSprite(windowWidth*0.5,windowHeight * 0.75,100,100);
...
ground  = Bodies.rectangle(windowWidth/2,windowHeight-5,windowWidth,15,{isStatic:true})
...
function draw(){
    ...
    text("Save  the  date",windowWidth * 0.42,windowHeight * 0.28)
    ...
    stroke("yellow");
    strokeWeight(2)
    text("24.04.2021",windowWidth * 0.42,windowHeight * 0.38)
